package com.prahlad.aijobportal.jobservice.security.filter;
 ...
 * {@code /api/v1/jobs/internal/admin/**} (never routed through the API
 ...
 * added here so Admin Service can manage jobs without duplicating Job

package com.prahlad.aijobportal.jobservice.exception;
...
/**
 * Centralized exception translation for the Job Service. Ensures every
 * error response — validation failures, business rule violations, and
 * unexpected errors alike — uses the same {@link ApiResponse} envelope

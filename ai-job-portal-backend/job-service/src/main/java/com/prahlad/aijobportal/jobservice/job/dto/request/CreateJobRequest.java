...
/**
 * Request payload for {@code POST /jobs}. The creating recruiter's
 * company identity is NOT accepted here — it is fetched authoritatively
 * from Recruiter Service via Feign at creation time.
 */

package com.prahlad.aijobportal.notificationservice.exception;
...
/**
 * Centralized exception translation for the Notification Service.
 * Ensures every error response — validation failures, business rule
 * violations, and unexpected errors alike — uses the same

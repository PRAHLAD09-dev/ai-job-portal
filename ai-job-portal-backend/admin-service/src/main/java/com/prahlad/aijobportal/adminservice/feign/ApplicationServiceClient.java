 ...
 */
@FeignClient(name = "APPLICATION-SERVICE", url = "${services.application-service.url:}", path = CommonConstants.API_BASE_PATH + "/applications/internal/admin", configuration = FeignClientConfig.class)

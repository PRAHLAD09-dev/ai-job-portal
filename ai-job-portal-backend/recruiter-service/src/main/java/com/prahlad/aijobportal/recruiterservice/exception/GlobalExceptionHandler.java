package com.prahlad.aijobportal.recruiterservice.exception;
...
/**
 * Centralized exception translation for the Recruiter Service. Ensures
 * every error response uses the same {@link ApiResponse} envelope and
 * never leaks a raw stack trace.
 */

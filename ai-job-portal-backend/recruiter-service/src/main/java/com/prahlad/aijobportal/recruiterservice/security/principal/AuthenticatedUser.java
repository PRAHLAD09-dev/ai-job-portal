package com.prahlad.aijobportal.recruiterservice.security.principal;
 ...
 * (userId, email, roles) — the Recruiter Service has no local user
 * table, so there is nothing to look up; the Auth Service remains the

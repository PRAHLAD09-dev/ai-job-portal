package com.prahlad.aijobportal.recruiterservice.security.filter;
 ...
 * {@code /api/v1/companies/internal/admin/**} (never routed through the
 * API Gateway) using a shared secret header, per DECISIONS.md ("Internal
 * JWT for Service-to-Service Communication"). Mirrors the identical
 * pattern already established in Auth Service's
 * {@code InternalServiceAuthFilter}, added here so Admin Service can
 * manage companies without duplicating Recruiter Service's business
 * logic.
 */
@Component
@Slf4j
